  ...
  return (
    <div className="space-y-4">
      {sortedSales.map((sale) => (
        <div key={sale.id} className="bg-white dark:bg-[#18191c] rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-shadow">
