...
export function BottomNavigation({ activeTab, onTabChange, onMenuClick }: BottomNavigationProps) {
  ...
  return (
    <>
      {/* Mobile Navigation */}
      <nav className="fixed bottom-0 left-0 right-0 bg-white/80 dark:bg-[#131416]/80 backdrop-blur-xl border-t border-gray-200/50 dark:border-gray-700/50 px-4 py-2 z-50 md:hidden">
