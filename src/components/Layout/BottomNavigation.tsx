...
import { Home, Package, ShoppingCart, ClipboardList, Settings, HandCoins, Wrench, TrendingUp, TrendingDown } from 'lucide-react';
...
export function BottomNavigation({ activeTab, onTabChange }: BottomNavigationProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#131416] border-t border-gray-200 dark:border-gray-700 px-1 py-2 z-50">
        ...
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-xs mt-1 font-medium truncate whitespace-nowrap">{tab.label}</span>
            </button>
          );
        })}
      </div>
