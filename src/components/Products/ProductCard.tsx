...
export function ProductCard({ product, onEdit, onDelete }: ProductCardProps) {
  ...
  return (
    <div className={`bg-white dark:bg-[#18191c] rounded-xl p-3 sm:p-4 shadow-sm border transition-all duration-200 hover:shadow-md ${
      isLowStock 
        ? 'border-red-200 dark:border-red-700 bg-red-50/50 dark:bg-red-950/80' 
      ...
      <div className="space-y-2">
        <div className={`flex items-center justify-between p-2 sm:p-2 rounded-lg ${
          isLowStock ? 'bg-red-100 dark:bg-red-900/30' : 'bg-gray-50 dark:bg-gray-700'
        }`}>
          <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300">Estoque:</span>
