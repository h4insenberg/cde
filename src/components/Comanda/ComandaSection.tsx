  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6 pb-20">
      ...
      <div className="bg-white dark:bg-[#18191c] rounded-xl p-3 sm:p-4 shadow-sm border border-gray-200 dark:border-gray-700">
        <div className="grid grid-cols-3 sm:flex sm:space-x-1 gap-1 sm:gap-0 bg-gray-100 dark:bg-gray-800/50 rounded-lg p-1">
          <button
            onClick={() => setFilter('all')}
            className={`px-2 sm:px-3 py-2 rounded-md transition-colors text-xs sm:text-sm text-center ${
              filter === 'all'
