    ...
    <div className={`bg-white dark:bg-[#18191c] rounded-xl p-3 sm:p-4 shadow-sm border transition-all duration-200 hover:shadow-md ${
      ...
      <div className="flex items-start justify-between mb-2 sm:mb-3">
        <div className="flex items-center space-x-2 flex-1">
          ...
          <h3 className="font-semibold text-sm sm:text-base text-gray-900 dark:text-white truncate">{comanda.customerName}</h3>
      ...
      {isOpen && (
        <div className="flex space-x-2">
          ...
          <button
            ...
            className="flex-1 px-2 sm:px-3 py-1.5 sm:py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center justify-center space-x-1 text-xs sm:text-sm"
          >
